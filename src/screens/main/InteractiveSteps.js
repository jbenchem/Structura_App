...
const iv = StyleSheet.create({
  ...
  traceBox: {
    ...
    borderRadius: R.md, paddingHorizontal: 18, paddingVertical: 8,
  },
  ...
  sortBtn: {
    ...
    borderWidth: 1.5, borderColor: C.tealBorder, backgroundColor: C.tealSoft, borderRadius: R.xs,
  },
  familyTag: {
    alignSelf: 'center', fontSize: 11, fontWeight: '800', letterSpacing: 0.8,
    paddingHorizontal: 12, paddingVertical: 5, borderRadius: R.xs, overflow: 'hidden', marginTop: 4,
  },
  ...
  stagePip: {
    width: 30, height: 30, borderRadius: R.md, alignItems: 'center', justifyContent: 'center',
    borderWidth: 1.5, borderColor: C.border, backgroundColor: C.card,
  },
  ...
  locTerm: {
    ...
    borderRadius: R.xs, paddingHorizontal: 6, paddingVertical: 1,
  },
