    ...
    },
    {
      ...
      steps: [
        ...
        MC(
          ...
          ['the same compound', 'structural isomers', 'different formulas'],
          1,
...
const U20 = {
  ...
  n: 21,
  title: 'Cycloalkanes',
  subtitle: 'Chains that close, and the isomers they create',
  level: 'VCE',
  topics: ['rings'],
  difficulty: 3,
  lessons: [
    ...
    },
    {
      ...
      steps: [
        T(
          ...
          'Both a ring and a double bond remove two hydrogens. So cyclohexane and hex-1-ene are both C6H12 — structural isomers, with nothing in the formula to tell them apart.\n\nWhen you meet CnH2n, it is an alkene OR a cycloalkane, and only the structure decides.',
          M.hexene1,
  ...
  lessons: [
    {
      ...
      steps: [
        T(
          ...
          'C4H10 describes two different substances. Four carbons in a row is butane; three in a row with one hanging off is 2-methylpropane.\n\nSame atoms, same counts, different connections — so different compounds, with different boiling points and different chemistry. These are CONSTITUTIONAL ISOMERS.',
          M.methylpropane,
        ...
        T(
          ...
          M.dimethylpropane,
          { caption: '2,2-dimethylpropane: the most branched of the three C5H12 isomers.' }
        ),
        MC(
  ...
  lessons: [
    {
      ...
      steps: [
        T(
          ...
          'C4H10 has two isomers. C5H12 has three. C6H14 has five, C7H16 has nine, and C10H22 has seventy-five.\n\nEach extra carbon adds more ways to branch, so the number climbs steeply. That is why "draw all the isomers" is a fair exam question at five or six carbons and an unreasonable one at ten.',
          M.dimethylbutane23,
    ...
    },
    {
      ...
      steps: [
        ...
        T(
          ...
          M.heptaneIso,
          { caption: 'Heptane. Its nine isomers come out in order if you work down by parent length.' }
        ),
        HUNT(
          'Now try C5H12',
    ...
    {
      id: 'u31-checkpoint',
      title: 'Checkpoint: counting isomers',
      checkpoint: true,
  ...
  lessons: [
    {
      ...
      steps: [
        T(
          ...
          'A carbon carrying four DIFFERENT groups is a CHIRAL CENTRE. A molecule with one exists in two forms that are mirror images — and, like your two hands, no amount of turning will lay one on the other.\n\nButan-2-ol is the smallest common example: carbon 2 carries an -OH, a hydrogen, a methyl and an ethyl. Four different things.',
          M.rButanol,
        ...
        MC(
          ...
          1,
          'OH, H and two methyls. Two the same, so no chiral centre.',
          M.propan2ol_achiral
        ),
        MC(
    ...
    },
    {
      ...
      steps: [
        ...
        FLIP(
          ...
          'Swapping any two groups on a chiral centre gives its mirror image. Try it.',
          ['(R)-butan-2-ol', '(S)-butan-2-ol'],
          {
            flipLabel: 'Swap two groups',
            noteDiffer:
              'R became S — the mirror image, and a different compound. Swapping any two groups on a chiral centre always reverses it.',
          }
        ),
        MC(
    ...
    },
    {
      ...
      steps: [
        ...
        T(
          'Why this matters',
          'The amino acids are the reason. 2-aminopropanoic acid — alanine — has one chiral centre, and living systems build proteins almost exclusively from the S form.\n\nThe R form has the same atoms joined the same way. Biologically it is a different substance.',
          M.alanineS,
  ...
  lessons: [
    ...
    },
    {
      ...
      steps: [
        ...
        T(
          'Where you meet them',
          'Heterocycles are everywhere in biology. Pyrimidine — a six-membered ring with two nitrogens — is the skeleton of cytosine and thymine, two of the four bases of DNA.\n\nThat is a fair note to end on: the naming system you have worked through is the one used to describe the molecules life is built from.',
          M.pyrimidineM,
