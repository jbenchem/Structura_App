...
const dv = StyleSheet.create({
  ...
  partBox: { backgroundColor: T_.tealSoft, borderRadius: R.xs, padding: 9, marginTop: 8 },
  ...
  steps: { maxHeight: 150, backgroundColor: T_.card, borderRadius: R.md, borderWidth: 1.5, borderColor: T_.border, marginBottom: 8 },
